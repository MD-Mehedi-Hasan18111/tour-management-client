      ...
      <div className="flex bg-[#ecf0f1]/60 w-screen h-screen">
        ...
        <div className="lg:block hidden bg-[white] border h-screen shadow-md w-[350px] py-4 px-6 relative">
          ...
          <div className="mt-6">
            ...
            <button className="absolute bottom-0 left-0 right-0 bg-[#34495e] hover:bg-[#34495e]/80 text-[white] py-[6px] px-[10px] w-full flex items-center justify-center space-x-2.5">
