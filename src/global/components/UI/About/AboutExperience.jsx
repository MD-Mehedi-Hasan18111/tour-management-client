...
const AboutExperience = () => {
  return (
    <div
      class="w-full bg-no-repeat bg-center bg-screen md:my-24 my-4"
      style={{
        backgroundImage: `url(${img.src})`,
      }}
    >
      <div class="md:flex md:flex-row flex-col md:gap-y-16 gap-y-0 md:gap-6">
        <div class="md:basis-1/2 w-full my-auto md:p-32 p-4 md:text-start text-center ">
          ...
          <p className="text-gray-500">
            Travelling to all corners of the world is getting easier and easier.
            We live in a global village, but how well do we know and understand
            each other? Here is a simple test. Imagine you have arranged a
