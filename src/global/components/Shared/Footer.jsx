...
const Footer = () => {
  return (
    <div className="bg-base-200">
      <div className="container mx-auto md:grid md:grid-cols-5 text-center md:text-start p-8  md:gap-4 mb:m-24">
        ...
        <div>
          <ul className="type-none my-4">
            ...
            <li className="flex items-center justify-start gap-2 my-2 font-medium ">
              {" "}
              <FiPhoneCall />{" "}
      ...
      <footer className="container mx-auto footer px-10 py-4 border-t  text-base-content border-base-300">
        ...
        <nav className="md:place-self-center md:justify-self-end md:me-24 me-0 ">
